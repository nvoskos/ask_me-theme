jQuery(document).ready( function($) {
	...
	function ask_setting(whats) {
		var ask_setting = jQuery("#"+whats+":checked").length;
		if (ask_setting == 1) {
			jQuery("#wrap_"+whats).show(10);
		}else {
			jQuery("#wrap_"+whats).hide(10);
		}
		jQuery("#"+whats).click(function () {
			var ask_setting = jQuery("#"+whats+":checked").length;
			if (ask_setting == 1) {
				jQuery("#wrap_"+whats).slideDown(500);
			}else {
				jQuery("#wrap_"+whats).slideUp(500);
			}
		});
	}
	
	function ask_setting_2(whats) {
		var ask_setting_2 = jQuery("#"+whats+":checked").length;
		if (ask_setting_2 == 1) {
			jQuery("#wrap_"+whats).hide(10);
		}else {
			jQuery("#wrap_"+whats).show(10);
	...
	ask_setting("point_back");
	ask_setting("ask_question_no_register");
	ask_setting("category_question");
	ask_setting("send_email_new_question");
	ask_setting("terms_active");
	ask_setting("video_desc_active_loop");
	ask_setting_2("title_question");
	
	/* Logo */
	if (jQuery("#"+vpanel_name+"-logo_display-custom_image:checked").length > 0) {
		jQuery("#logo_img,#retina_logo,#logo_height,#logo_width").parent().parent().parent().show(10);
	}else {
		jQuery("#logo_img,#retina_logo,#logo_height,#logo_width").parent().parent().parent().hide(10);
	}
	jQuery("#"+vpanel_name+"-logo_display-custom_image").click(function () {
		jQuery("#logo_img,#retina_logo,#logo_height,#logo_width").parent().parent().parent().slideDown(500);
	});
	jQuery("#"+vpanel_name+"-logo_display-display_title").click(function () {
		jQuery("#logo_img,#retina_logo,#logo_height,#logo_width").parent().parent().parent().slideUp(500);
	});
	
	if (jQuery("#"+vpanel_name+"-questions_logo_display-custom_image:checked").length > 0) {
		jQuery("#questions_logo_img,#questions_retina_logo,#questions_logo_height,#questions_logo_width").parent().parent().parent().show(10);
	}else {
		jQuery("#questions_logo_img,#questions_retina_logo,#questions_logo_height,#questions_logo_width").parent().parent().parent().hide(10);
	}
	jQuery("#"+vpanel_name+"-questions_logo_display-custom_image").click(function () {
		jQuery("#questions_logo_img,#questions_retina_logo,#questions_logo_height,#questions_logo_width").parent().parent().parent().slideDown(500);
	});
	jQuery("#"+vpanel_name+"-questions_logo_display-display_title").click(function () {
		jQuery("#questions_logo_img,#questions_retina_logo,#questions_logo_height,#questions_logo_width").parent().parent().parent().slideUp(500);
	});
	
	if (jQuery("#"+vpanel_name+"-products_logo_display-custom_image:checked").length > 0) {
		jQuery("#products_logo_img,#products_retina_logo,#products_logo_height,#products_logo_width").parent().parent().parent().show(10);
	}else {
		jQuery("#products_logo_img,#products_retina_logo,#products_logo_height,#products_logo_width").parent().parent().parent().hide(10);
	}
	jQuery("#"+vpanel_name+"-products_logo_display-custom_image").click(function () {
		jQuery("#products_logo_img,#products_retina_logo,#products_logo_height,#products_logo_width").parent().parent().parent().slideDown(500);
	});
	jQuery("#"+vpanel_name+"-products_logo_display-display_title").click(function () {
		jQuery("#products_logo_img,#products_retina_logo,#products_logo_height,#products_logo_width").parent().parent().parent().slideUp(500);
	});
	
	/* Big video */
	
	if (jQuery("#big_video:checked").val() == "on") {
		jQuery("#wrap_video_setting").show(10);
	}else {
		jQuery("#wrap_video_setting").hide(10);
	}
	jQuery("#big_video").click(function () {
		if (jQuery("#big_video:checked").val() == "on") {
			jQuery("#wrap_video_setting").slideDown(500);
		}else {
			jQuery("#wrap_video_setting").slideUp(500);
		}
	});
	
	if (jQuery("#video_type").val() == "html5") {
		jQuery("#wrap_video_html5_setting").show(10);
		jQuery("#section-video_id").hide(10);
	}else if (jQuery("#video_type").val() == "embed") {
		jQuery("#section-custom_embed").show(10);
		jQuery("#section-video_id,#wrap_video_html5_setting").hide(10);
	}else {
		jQuery("#section-video_id").show(10);
		jQuery("#wrap_video_html5_setting,#section-custom_embed").hide(10);
	}
	jQuery("#video_type").change(function () {
		if (jQuery("#video_type").val() == "html5") {
			jQuery("#wrap_video_html5_setting").slideDown(500);
			jQuery("#section-video_id").slideUp(500);
		}else if (jQuery("#video_type").val() == "embed") {
			jQuery("#section-custom_embed").slideDown(500);
			jQuery("#section-video_id,#wrap_video_html5_setting").slideUp(500);
		}else {
			jQuery("#section-video_id").slideDown(500);
			jQuery("#wrap_video_html5_setting,#section-custom_embed").slideUp(500);
		}
	});
	
	/* After register */
	var after_register = jQuery("#after_register").val();
	if (after_register == "custom_link") {
		jQuery("#section-after_register_link").slideDown(500);
	}else {
		jQuery("#section-after_register_link").slideUp(500);
	}
	...
	/* After login */
	var after_login = jQuery("#after_login").val();
	if (after_login == "custom_link") {
		jQuery("#section-after_login_link").slideDown(500);
	}else {
		jQuery("#section-after_login_link").slideUp(500);
	}
	
	jQuery("#after_login").change(function () {
		var after_login = jQuery(this).val();
		if (after_login == "custom_link") {
			jQuery("#section-after_login_link").slideDown(500);
		}else {
			jQuery("#section-after_login_link").slideUp(500);
	...
	/* User group */
	if (jQuery("#custom_permission:checked").val() == "on") {
		jQuery(".custom_permission_note,#section-ask_question,#section-show_question,#section-add_answer,#section-show_answer,#section-add_post,#section-send_message,#section-roles").show(10);
	}else {
		jQuery(".custom_permission_note,#section-ask_question,#section-show_question,#section-add_answer,#section-show_answer,#section-add_post,#section-send_message,#section-roles").hide(10);
	}
	jQuery("#custom_permission").click(function () {
		if (jQuery("#custom_permission:checked").val() == "on") {
			jQuery(".custom_permission_note,#section-ask_question,#section-show_question,#section-add_answer,#section-show_answer,#section-add_post,#section-send_message,#section-roles").slideDown(500);
		}else {
			jQuery(".custom_permission_note,#section-ask_question,#section-show_question,#section-add_answer,#section-show_answer,#section-add_post,#section-send_message,#section-roles").slideUp(500);
		}
	});
	...
	if (custom_page_setting == 1) {
		jQuery("#vbegy_sticky_sidebar_s").parent().parent().parent().show(10);
		jQuery("#vbegy_post_meta_s").parent().parent().parent().show(10);
		jQuery("#vbegy_post_share_s").parent().parent().parent().show(10);
		jQuery("#vbegy_post_author_box_s").parent().parent().parent().show(10);
		jQuery("#vbegy_related_post_s").parent().parent().parent().show(10);
		jQuery("#vbegy_post_comments_s").parent().parent().parent().show(10);
		jQuery("#vbegy_post_navigation_s").parent().parent().parent().show(10);
	}else {
		jQuery("#vbegy_sticky_sidebar_s").parent().parent().parent().hide(10);
		jQuery("#vbegy_post_meta_s").parent().parent().parent().hide(10);
		jQuery("#vbegy_post_share_s").parent().parent().parent().hide(10);
		jQuery("#vbegy_post_author_box_s").parent().parent().parent().hide(10);
		jQuery("#vbegy_related_post_s").parent().parent().parent().hide(10);
		jQuery("#vbegy_post_comments_s").parent().parent().parent().hide(10);
		jQuery("#vbegy_post_navigation_s").parent().parent().parent().hide(10);
	}
	jQuery("#vbegy_custom_page_setting").click(function () {
		var custom_page_setting = jQuery("#vbegy_custom_page_setting:checked").length;
		if (custom_page_setting == 1) {
			jQuery("#vbegy_sticky_sidebar_s").parent().parent().parent().slideDown(500);
			jQuery("#vbegy_post_meta_s").parent().parent().parent().slideDown(500);
			jQuery("#vbegy_post_share_s").parent().parent().parent().slideDown(500);
			jQuery("#vbegy_post_author_box_s").parent().parent().parent().slideDown(500);
			jQuery("#vbegy_related_post_s").parent().parent().parent().slideDown(500);
			jQuery("#vbegy_post_comments_s").parent().parent().parent().slideDown(500);
			jQuery("#vbegy_post_navigation_s").parent().parent().parent().slideDown(500);
		}else {
			jQuery("#vbegy_sticky_sidebar_s").parent().parent().parent().slideUp(500);
			jQuery("#vbegy_post_meta_s").parent().parent().parent().slideUp(500);
			jQuery("#vbegy_post_share_s").parent().parent().parent().slideUp(500);
			jQuery("#vbegy_post_author_box_s").parent().parent().parent().slideUp(500);
			jQuery("#vbegy_related_post_s").parent().parent().parent().slideUp(500);
			jQuery("#vbegy_post_comments_s").parent().parent().parent().slideUp(500);
			jQuery("#vbegy_post_navigation_s").parent().parent().parent().slideUp(500);
		}
	});
	...
	if (page_template == "template-users.php") {
		jQuery("#users_template").show(10);
	}else {
		jQuery("#users_template").hide(10);
	}
	
	if (page_template == "template-categories.php") {
		jQuery("#categories_template").show(10);
	}else {
		jQuery("#categories_template").hide(10);
	}
	
	if (page_template == "template-tags.php") {
		jQuery("#tags_template").show(10);
	}else {
		jQuery("#tags_template").hide(10);
	}
	
	if (page_template == "template-forum.php") {
		jQuery("#forum_option").show(10);
	}else {
		jQuery("#forum_option").hide(10);
	}
	...
	if (page_template == "template-faqs.php") {
		jQuery("#faqs_template").show(10);
	}else {
		jQuery("#faqs_template").hide(10);
	}
	...
	jQuery("#page_template").change(function () {
		...
		if (page_template == "template-users.php") {
			jQuery("#users_template").slideDown(500);
		}else {
			jQuery("#users_template").slideUp(500);
		}
		
		if (page_template == "template-categories.php") {
			jQuery("#categories_template").slideDown(500);
		}else {
			jQuery("#categories_template").slideUp(500);
		}
		
		if (page_template == "template-tags.php") {
			jQuery("#tags_template").slideDown(500);
		}else {
			jQuery("#tags_template").slideUp(500);
		}
		
		if (page_template == "template-forum.php") {
			jQuery("#forum_option").slideDown(500);
		}else {
			jQuery("#forum_option").slideUp(500);
		}
	...
	if (jQuery("#vbegy_index_tabs").val() == 1) {
		jQuery("label[for='vbegy_what_tab'],label[for='vbegy_sort_home_elements'],label[for='vbegy_categories_show'],label[for='vbegy_pagination_tabs'],label[for='vbegy_posts_per_page']").parent().parent().slideDown(500);
	}else if (jQuery("#vbegy_index_tabs").val() == 2) {
		jQuery("label[for='vbegy_posts_per_page']").parent().parent().slideDown(500);
		jQuery("label[for='vbegy_what_tab'],label[for='vbegy_sort_home_elements'],label[for='vbegy_categories_show'],label[for='vbegy_pagination_tabs']").parent().parent().slideUp(500);
	}else {
		jQuery("label[for='vbegy_what_tab'],label[for='vbegy_sort_home_elements'],label[for='vbegy_categories_show'],label[for='vbegy_pagination_tabs'],label[for='vbegy_posts_per_page']").parent().parent().slideUp(500);
	}
