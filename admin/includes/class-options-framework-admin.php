...
class Options_Framework_Admin {
	...
	function enqueue_admin_scripts() {
		...
		wp_localize_script("ahmed","confirm_delete_attachment",__("If you press will delete the attachment !","vbegy"));
		...
		wp_localize_script("builder_admin","ask_theme",vpanel_options);
		wp_localize_script("builder_admin","categories",$categories);
		wp_localize_script("builder_admin","builder_on",esc_html__("ON","vbegy"));
		wp_localize_script("builder_admin","builder_off",esc_html__("OFF","vbegy"));
		...
		<div id="optionsframework-wrap">
		    <form action="options.php" id="main_options_form" method="post">
				<div class="optionsframework-header">
					<a href="https://themeforest.net/item/ask-me-responsive-questions-answers-wordpress/7935874?ref=2codeThemes" target="_blank"></a>
	...
	function validate_options( $input ) {
		...
		foreach ( $options as $option ) {
			...
			if ( 'multicheck' == $option['type'] && 'multicheck_sort' == $option['type'] && ! isset( $input[$id] ) ) {
