							...
							<div class="form-inputs clearfix">
								...
								if (is_user_logged_in && $private_answer == 1) {
									...
									<p class="private_answer_p">
										...
										<input type="checkbox" id="private_answer" name="private_answer" value="1" '.($a_private_answer == 1?"checked='checked'":"").'>
										<span class="private_answer">'.__("Active this answer as a private answer.","vbegy").'</span>
									</p>
