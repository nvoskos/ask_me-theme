...
get_header();
	...
	<div class="page-content page-content-user">
		<div class="user-questions">
			...
			$args = array('post_type' => 'question','paged' => $paged,'posts_per_page' => $rows_per_page,'author' => $user_login->ID,"meta_query" => array('relation' => 'AND',array("key" => "user_id","compare" => "NOT EXISTS"),array('type' => 'numeric',"key" => "_paid_question","value" => 'paid',"compare" => "==")));
			query_posts($args);
