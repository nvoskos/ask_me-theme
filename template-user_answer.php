...
get_header();
	...
	$comments_all = get_comments(array('user_id' => $user_login->ID,"status" => "approve",'post_type' => 'question',"meta_query" => array(array("key" => "answer_question_user","compare" => "NOT EXISTS"))));
	if ($comments_all) {
