	...
	<div id="commentlist" class="page-content <?php if (is_page()) {echo "no_comment_box";}?>">
		...
		if ($custom_permission != 1 || (is_user_logged_in && isset($roles["show_answer"]) && $roles["show_answer"] == 1) || (!is_user_logged_in && $show_answer == 1)) {
			...
			<ol class="commentlist clearfix">
				<?php $answers_sort = vpanel_options("answers_sort");
			    ...
			    <?php }else {
					if ($post_comments_user_active == true) {
						...
						if (have_comments()) {
							...
							}else if ((isset($question_category[0]) && !isset($get_question_category['special'])) || !isset($question_category[0])) {
								$yes_special = 0;
							...
							<?php }else {?>
								<form action="<?php echo esc_url(site_url( '/wp-comments-post.php' ))?>" method="post" id="commentform" enctype="multipart/form-data">
									...
									<div class="clearfix">
									    ...
									    $featured_image_answer = vpanel_options("featured_image_answer");
								    ...
								    <?php $private_answer = vpanel_options("private_answer");
								    if (is_user_logged_in && $private_answer == 1) {
								    	...
								    	<p class="private_answer_p">
								    		...
								    		<span class="private_answer"><label for="private_answer">'.__("Active this answer as a private answer.","vbegy").'</label></span>
								    	</p>
